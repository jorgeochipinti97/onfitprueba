                        ...
                        <>
                            <Box display='flex' justifyContent='space-around' sx={{ mt: 5 }}>
                                <Button onClick={() => handleOpenFedex()}>
                                    <Box sx={{ m: 1 }}>
                                        <Image src='/fedex.jpeg' width={150} height={100} alt={''} />
                                    </Box>
                                </Button>

                                <Button onClick={() => handleOpen()}>
                                    <Box sx={{ m: 1 }}>
                                        <Image src='/dhl.jpg' width={150} height={100} alt={''} />
                                    </Box>
                                </Button>
                            </Box>
                            ...
                            >
                                <Box sx={style}>
                                    <Image src='/guia.jpg' width={500} height={500} alt={''} />
                            ...
                            >
                                <Box sx={style}>
                                    <Image src='/guia_fedex.jpg' width={500} height={500} alt={''} />
